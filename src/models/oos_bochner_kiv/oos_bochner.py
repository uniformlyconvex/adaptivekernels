...
class OOSBochnerKIV:
    ...
    def __post_init__(self):
        ...
        self.X_kernel = BochnerKernel(dimension=self.data.all_X.shape[1], lengthscales=X_lengthscales, device=self.device)
        self.Z_kernel = BochnerKernel(dimension=self.data.all_Z.shape[1], lengthscales=Z_lengthscales, device=self.device)
    ...
    def stage_1(self, iterations: int=20, minibatched: bool=True) -> StageLosses:
        ...
        for i in range(iterations):
            ...
            for stage_1, stage_2 in self.data.minibatches(MINIBATCH_SIZE):
                ...
                stage_2_unregularized_loss.backward()
                self.Z_opt.step()
        ...
        return StageLosses(
            ...
            metrics=[
                ...
                (stage_2_unregularized_loss_overall, "TARGET: Stage 2 data (unregularized)")
            ]
        )
    ...
    def stage_2(self, iterations: int=1, minibatched: bool=True) -> StageLosses:
        ...
        for i in range(iterations):
            ...
            for stage_1, stage_2 in self.data.minibatches(MINIBATCH_SIZE):
                ...
                stage_1_unregularized_loss.backward()
        ...
        return StageLosses(
            ...
            metrics=[
                ...
                (stage_1_unregularized_loss_overall, "TARGET: Stage 1 data (unregularized)")
            ]
        )
